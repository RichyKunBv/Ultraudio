...
public partial class HistoryWindow : Window
{
    public HistoryWindow()
    {
        ...
        var versions = new List<string>
        {
            ...
            "V0.9.14 - Solución y optimización del control de teclas multimedia a nivel de sistema operativo.",
            "V0.9.13 - Mejoras de estabilidad y rendimiento en la reproducción y la interfaz gráfica.",
            "V0.9.12 - Soporte para MPRIS2 en Linux mediante D-Bus para integración nativa con playerctl y entornos de escritorio.",
